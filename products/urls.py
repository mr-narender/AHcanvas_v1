...
urlpatterns = [
    ...
    path("edit_combination/detail/<product_sku>/<int:pk>/", views.edit_combination, name="edit_combination"),
    path("edit_product/detail/<product_sku>/", views.edit_product, name="edit_product"),
    path("delete_product/detail/<product_sku>/", views.delete_product, name="delete_product"),
